...
const Users = () => {
  ...
  return (
    <>
  <div className="flex ">
    <img className="w-12  mx-3 my-4 br-20 rounded-full"  src={usuario.img} alt="user" />
  ...
  <img className="w-4 absolute place-content-center" src="https://cdn-icons-png.flaticon.com/512/263/263056.png" alt="" />__     Puntos 
</button>
